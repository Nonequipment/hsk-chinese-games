...
export function ExamRoute() {
  ...
  useEffect(() => { if (started && !result && type !== 'meaning') answerInput.current?.focus(); }, [index, type, started, result]);
