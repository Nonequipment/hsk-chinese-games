...
function questionGuide(type: QuestionType, item: VocabularyItem) {
  ...
  return `คำแปล “${item.thai}” · พิมพ์พินอินพร้อมเลขวรรณยุกต์`;
}
